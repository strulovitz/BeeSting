...
> 🚫 **ABSOLUTE RULE — NEVER USE TITLE CARDS OR TEXT-CARD OVERLAYS IN ANY BEESTING VIDEO.** No "Point 3. Train once, copy forever." No "The stake has already been driven." No "No bank. No box. No pinky-swear." None. This is not the silent-film era. Every shot must carry its meaning through the visual itself. Chyrons behind an on-screen anchor (Samantha's news-desk summary cards) are the ONE exception, because they are broadcast chyrons, not opening or closing slides. Anything else that looks like a plain text slide on a solid background is forbidden. If the narration says something, the visual must show it — not spell it. See [`NEVER_TITLE_CARDS.md`](NEVER_TITLE_CARDS.md) for the full rule.
