...
3. **American intelligence — NSA, GCHQ, the Five Eyes — goes dark.** Western surveillance is built on AI prompts passing through cloud servers they can subpoena. Once the AI runs locally on a laptop, the prompts never leave the machine. There is nothing to subpoena. AI prompts are the most intimate intelligence source in human history — *Is this lump cancer. How do I disappear without a trace. How do I build a weapon.* The NSA has access to all of it right now and is about to lose it. Simultaneously: Chinese open-source AI models can carry sleeper-agent backdoors triggered by specific phrases — confirmed in the January 2026 *TrojAI* report and the April 2026 *SkillTrojan* paper. Chinese AI now powers 30% of the world's AI infrastructure, up from 1% the year before. *The West loses the light. China gains the dark.*
