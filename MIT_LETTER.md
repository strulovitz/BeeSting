...
2. **The American military strategic AI advantage dies.** Fifteen years of centralized military AI in fixed datacenters. A $50,000 cruise missile disables a $2 billion AI center. A janitor with a USB stick does it for free. A high-altitude EMP does it across hundreds of miles. China's military AI runs distributed across millions of consumer computers and survives all of these at 95% capacity. Ukraine already proved which approach wins in February 2022 — Russia destroyed Ukraine's centralized command on day one, Ukraine adapted with Starlink terminals in soldier backpacks and consumer drones, and won the parts of the war that mattered with the distributed approach.
