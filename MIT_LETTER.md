...
7. **American defense contractors die.** Here is what specifically happens to Lockheed Martin, RTX, Northrop Grumman, Boeing, and General Dynamics:
   - **The engineers' advantage dies — the simulation tools become free, and brute-force replaces expertise.** What defense contractors actually do, all day, every day, is simulate: aerodynamics in Ansys ($30K–$320K per seat per year), structures in COMSOL, electronics in MATLAB, multiphysics in COMSOL, CAD in SolidWorks. The American advantage is not factories or raw materials — China has both — it is thousands of PhD engineers using these expensive tools to narrow the parameter search by expertise. Every one of those tools has a free open-source equivalent that runs on a consumer laptop: OpenFOAM, GNU Octave, FreeCAD, Elmer FEM, CalculiX. The hive runs them in parallel on a thousand consumer machines, each worker testing one parameter configuration. The American engineer narrows the search by expertise. The Chinese hive brute-forces the entire parameter space. The expensive-tool advantage dies; the PhD-engineer advantage dies with it.
   - **The F-35 precedent — China stole the answer in 2007–2014, and the hive gives China the question.** Between 2007 and 2009, Chinese hackers stole 630,000 files from the F-35 and F-22 programs — engine schematics, radar designs, airframe specifications. The result was the Shenyang J-35, a stealth fighter that bears a striking resemblance to the F-35 and is now sold to other countries. But stealing has a hard limit: you get the design, not the institutional knowledge of why that particular design beat ten thousand alternatives. You get the answer, not the ability to ask the question. The hive removes that limit. With a thousand workers running free simulation software in parallel, China can explore the same parameter space Lockheed explored — and design the next stealth fighter from scratch, on cheap hardware, without needing to steal anything. They had the answer. Now they have the question.
   - **Military-Civil Fusion is hive policy by another name — and China's 15th Five-Year Plan funds it directly.** China's "Military-Civil Fusion" doctrine, written into the 15th Five-Year Plan (2026–2030), explicitly channels civilian computing infrastructure, talent, and AI into military simulation. The hive is a system that organizes civilian computers for distributed simulation tasks. Military-Civil Fusion is the policy; the hive is the implementation. Chinese defense researchers are already using DeepSeek to generate 10,000 military scenarios in 48 seconds — a process that previously took 48 hours — and are building full-stack simulation ecosystems for the entire weapon-system lifecycle, from the J-20 stealth fighter to next-generation naval assets. The hive layered on top of all of this turns every Chinese household computer into a node in the national defense simulation grid.
   - **The economic model collapses when 90 percent as good costs 10 percent as much.** The F-35 program will cost $1.7 trillion over its lifetime — the most expensive weapons program in human history. Lockheed received over $60 billion in U.S. government contracts in 2023; Northrop, RTX, Boeing, and General Dynamics are at comparable scale. A significant fraction of that money pays for the engineering advantage — the simulation infrastructure, the supercomputers, the PhD engineers, the decades of institutional knowledge. If the hive lets China replicate 90 percent of that engineering output on consumer hardware with free simulation software — and they only need 90 percent, because they are not trying to build better weapons than America, only good-enough weapons in larger quantities — then what is the American taxpayer paying for? The product is not bad. The F-35 is extraordinary. The price becomes indefensible when the alternative is 90 percent as good at a tenth of the cost.
   - **AI is already replacing engineers, and the curve is exponential.** Publicly published benchmarks designed to measure AI on real-world professional work (such as the GDPval benchmark) show AI achieving a 23-percent win rate against human mechanical engineers with an average of 14 years of experience, and 17 percent against industrial engineers — in 2026. AI already dominates software engineering; mechanical, electrical, and electronic engineering are largely software in modern practice (circuits are designed in software, simulated in software, programmed in software). The question is not whether AI will replace defense engineers — that is happening regardless of the hive. The question is whether the AI that replaces them will be American (centralized, expensive, controlled) or distributed, free, and running on a thousand Chinese computers organized as a hive.
