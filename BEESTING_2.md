# BeeSting Part 2 — canonical narration script
...
**Status:** All 12 blocks drafted as of 2026-04-24. Mechanism explainers Blocks 3–11 reordered 2026-04-24 by intensity (strongest content earliest) so the knockout argument lands before YouTube drop-off — the 9 teasers in Block 2.8 and the 9 mechanism blocks are now in matching order 1→9. Block 12 is the combined closing (equations + YouTube/GitHub credits on one near-black screen — see `CLOSING_SHOT_PLAN.md`). There is no separate Block 13.
**Rule:** same as BeeSting Part 1 — not one word changes unless Nir edits this file himself.

---

## 🚨 Absolute rule for this entire script (Nir lock)

**NEVER say the real company names.** Not in narration. Not in chyrons. Not in descriptions. Not anywhere.

- ❌ Never: OpenAI, Google, Anthropic, xAI, ChatGPT, Claude, Gemini, Grok
- ✅ Always: "American Big AI," "Big Tech," "the American cloud giants," "Silicon Valley"
- ✅ Parody names (kept in reserve for possible later use, not used in Block 2): CloseAI · Goggle · Misanthropic · eXAI
- ✅ DeepSeek, Qwen, Kimi, Alibaba, Moonshot — real Chinese companies, they are not the target
- ✅ AlphaGo — historical AI project, named without its parent company

---

## Narrator / voice roster

- **Samantha** — studio anchor at "AI News." Authoritative, clear, female news-desk cadence. **She is the Ep2 narrator throughout the entire episode**, including voice-over between segments. Replaces Frank from Ep1.
- **Tony** — field correspondent. Warmer, "on the street" energy. Male.
- **Ten vox-pop characters** — one line each, distinct demographics, authentic vernacular (do NOT clean up the grammar; the differences between "don't" and "doesn't" belong to the characters).
- **AI-Feynman** — white, older, thin generic likeness ONLY. NO photo reference of the real Feynman. NO voice clone of the real Feynman. Older male ElevenLabs voice with a hint of New York cadence. Content strictly from the MadHoney prologue — no words put in his mouth. This is the only block where AI-Feynman speaks.

---

## Block 1 — The equation hook + Golden Gate collapse

**Visual sequence:**
1. Equation frame: 🇨🇳 + 💪 + ➕ + 🇮🇱 + 🧠 + ➡️ + 🇺🇸 + 💀 (Chinese flag + muscle hand, plus, Israeli flag + brain, equals, American flag + skull)
2. **Clip A** (6s, Kling): Golden Gate Bridge, beautiful, time-lapse of rust spreading across the span
3. **Clip B** (6s, Kling): Same Golden Gate Bridge, rusted, collapsing into the bay

**Narration (Samantha's voice, played OVER the three visuals above):**

> *"The revolutionary Israeli software, combining half a billion Chinese computers into one AI, will collapse Big Tech tomorrow. Silicon Valley is about to become the new Rust Belt."*

---

## Block 2 — AI News broadcast

### Block 2.1 — Samantha, studio open (~15s)

> *"Good evening. I'm Samantha. This is AI News."*
>
> *"Our top story tonight: American Big Tech is collapsing — overnight."*
>
> *"A free open-source system from Israel is combining half a billion Chinese computers into a single coordinated AI. Americans are walking away from Big AI subscriptions en masse. The scale and speed of this shift is already dwarfing the first DeepSeek Moment — the day Nvidia lost six hundred billion dollars of market value in a single trading session."*
>
> *"We go now to our correspondent Tony, live from the Bay Area."*

### Block 2.2 — Tony, field open (~10s)

> *"Thanks, Samantha. I'm here on the streets where American Big Tech lives — and where users are walking away by the million, overnight. I asked them why. Here's what they said."*

### Block 2.3 — Vox pop (ten people, order locked, ~90s total)

Each person is captured in a short street-interview clip. Different ElevenLabs voice per character. Lines preserved verbatim — vernacular stays.

**1. Surfer dude** (coffee shop, open laptop, ocean through the window):
> *"What do I use more? Big AI or the Hive? I just use the Hive for everything."*

**2. California beach babe** (bikini, roller blades, boardwalk) — frame character, will return at #10:
> *"Why do I use the Chinese Hive instead of American Big AI?"*
>
...
**10. Beach babe returns** (same bikini, same blonde hair, same roller blades — OpenArt reference image locked, Kling multi-reference image to preserve continuity as much as Kling allows):
> *"I don't know. It's just better than American Big AI in every possible way. And the Hive is super-cool."*
>
> [Smiles a gorgeous smile. Skates away on the roller blades. Doesn't try to convince anyone. It's that obvious.]

### Block 2.4 — Tony, segment closer with DeepSeek Moment² reveal (~25s)

**Terminology lock:** *DeepSeek* is the name of a company / model. *DeepSeek Moment* is the name of the event — the 9/11 of the Nasdaq — when Nvidia lost $600 billion in a single day. The term everyone now remembers. That is the term we use and squared.

On-screen chyron during this block: *"BREAKING — The Hive."* As Tony says the word *"superscript,"* the **2** after "DeepSeek Moment" visibly floats up into superscript position to become **DeepSeek Moment²**. Two OpenArt reference images (ChatGPT Image 1.5): one for "DeepSeek Moment 2" flat, one for "DeepSeek Moment²" with the 2 in superscript — Kling interpolates between them.

> *"So to our viewers who have been living under a rock: the Hive is here to stay."*
>
> *"This is not DeepSeek Moment 2."*
>
> *"This time, the 2 is a superscript."*
>
> [on-screen text resolves: **DeepSeek Moment²**]
>
...
### Block 2.5 — Samantha, studio link to Feynman (~10s)

> *"Thank you, Tony, for bringing us the voices of the Bay Area."*
>
> *"Joining us now in the studio: an expert in the field — an AI version of Professor Richard Feynman from Caltech."*
>
> *"Professor — could you explain the Hive so the people at home can understand?"*

### Block 2.6 — AI-Feynman, the "you just ask them" explanation (~45s)

Content strictly adapted from the MadHoney prologue's "You Just Ask Them" section (pp. 127–139 of `prologue.md`).

> *"Let me tell you something personal."*
>
> *"Many years ago, I could not figure out how to get a girl at a bar. I bought her drinks. I was clever. I was a gentleman. And I got nothing."*
>
> *"Then an old nightclub master of ceremonies took me aside, and he taught me the secret. Don't buy her anything. Just — ask her. 'Will you sleep with me tonight?' And it worked."*
>
> *"I was stunned. I said — 'You mean… you just ask them?'"*
>
> *"The entire distributed AI system — the Hive — works on exactly the same principle. To build a parallel AI that scales infinitely, costs almost nothing, and rivals supercomputers — it is not sophisticated coding. It is not a billion-dollar research lab. It is not a breakthrough algorithm."*
>
> *"You just ask the AI to split the task. Then you ask the AI to combine the results. That is the whole trick."*

### Block 2.7 — Samantha, the four-word payoff (~10s)
...
**1. THE HIVE PAYS YOU BACK. 💰**
> *"One. The Hive pays you back. Your idle computer becomes a paycheck. Every query earns money. Not something China forces on you — something you join because it pays."*

**2. NO INTERNET NEEDED. 🔌**
> *"Two. No internet needed. Submarine. Forward operating base. Disaster zone. The Hive runs on your own local network. Big AI needs a live pipe to a United States data center. The Hive does not."*
...
> *"Four. Snowden diagnosed. The Hive cures. Every question you ask Big AI reveals whether you have cancer, a mistress, or are gay. Big AI sells that data — BIG DATA re-identify you in seconds. Your insurance raises your premium. Your employer does not hire you. In PUBLIC-MODE - The hive is run by many people just like YOU, competition keeps them straight."*
...
**6. EVERY SENSE. 🌐**
> *"Six. The Hive runs any kind of model. Text. Vision. Speech. Audio. Video. It does not care what the Worker runs — only that the Worker returns a result. Where there is demand there will be supply: the market will arrange a specialized hive for any model on Huggingface: Multi-modal , Mixture of Experts , and so on."*
...
**8. YOURS TO BUILD. 🔧**
> *"Eight. The hive is yours to build. A robotics company adds its own physics library. An engineering firm adds its own mathematical packages. Big AI is take it or leave it. The Hive is whatever you build."*

**9. INFINITE STACK. ♾️**
> *"Nine. Infinite stacking. The Hive is hierarchical — stack layer upon layer, as many as your hardware allows. China has half a billion computers. Your ceiling is whatever you already own."*

### Block 2.9 — Samantha, bridge to the mechanism explainers (~10s)

> *"Coming up: how each of these nine advantages actually works. Starting with the first promise — that the Hive pays the American folks real money back. Stay with us."*

---

## Block 3 — Mechanism cashing Point 1: The Hive pays the American folks real money back

**Named concept:** *A Free Source of Income for Joe Sixpack and Plain Jane.*
**Visual style:** Kurzgesagt flat 2D motion graphics.
**Palette:** forest green + warm gold + cream — money / growth / honey. Warm welcoming palette appropriate for the opening mechanism block.
...
**Catchy-name text card behind Samantha in Block 2.8 Point 1:** stays as the short version — **THE HIVE PAYS YOU BACK** (locked, do not expand the on-screen card).

### Block 3.1 — The narration (Samantha, ~120s)

> *"Point one. The Hive pays the American folks real money back. A free source of income for Joe Sixpack and Plain Jane. Here's how."*
>
> *"Two modes. Private Mode is inside walls for secrets. Public Mode is home computers connected over the internet into many separate hives."*
>
...
| S3a | Hotel building exterior with a glowing rating-star sign. 1000 tiny review speech-bubbles pour out of the hotel and stream toward a Hive server icon. Caption: *"1000 reviews..."* | 6 |
| S3b | The Hive server fans the reviews out — happy piles and angry piles forming simultaneously in parallel, sorted at speed. Caption: *"...in parallel."* | 6 |
...
| S19 | Landing beat (plays after narration ends): camera pulls back. All three tombstones fully carved, standing side by side under a grey sky. A single wilted flower falls slowly from above onto the BIG TECH grave. Six-second held aftermath — the audience absorbs the closer before Block 4 begins. | 6 |

---

## Block 4 — Mechanism cashing Point 2: No internet needed (the insurance racket)
...
- The block reframes Point 2 ("No internet needed") from an outage-survival pitch into a **geopolitical insurance-racket argument** aimed specifically at Big Tech executives.
...
### Block 4.1 — The narration (Samantha, ~75s)

> *"Point two. No internet needed. Every company depends on the internet. When the internet breaks, Big AI breaks. When Big AI breaks, companies lose millions per hour."*
>
...
### Block 4.2 — Shot plan skeleton (7 shots × 6s = 42s nominal, shots stretch per audio-wins)
...
## Block 5 — Mechanism cashing Point 3: Every branch gets full attention
...
**Reference source:** the chess scene structure from the Honeymation Video 2 (Public Mode) — `Honeymation/scripts/video2_narration.md` scenes 5a/5b/5c. Block 5 follows the same three-beat Honeymation chess arc, then adds a fourth beat (Move 37 + AlphaGo vs. Hive hierarchy) that Honeymation did not have.
...
### Block 5.1 — The narration (Samantha, ~38s)
...
### Block 5.2 — Shot plan skeleton (4 shots × 6s = 24s nominal, S4 stretches per audio-wins)
...
| S4 | The chess board transitions into a **Go board**. A **three-tier hierarchy** is visible, each tier larger than the last. **LEFT (smallest):** the human Go champion silhouette, looking stumped. **MIDDLE (medium):** a single large computer / server tower, clearly labeled **ALPHAGO**. A red flag and the label **MOVE 37** float on the stone AlphaGo just placed on the Go board. **RIGHT (huge, dwarfs the other two):** a **tall Hive pyramid** towering over both. A tiny caption floats on the pyramid: **HALF A BILLION COMPUTERS · MISSES NOTHING**. | 6 |
...
### Block 6.3 — Reference-image pipeline (for Sonnet / OpenArt / Kling hand-off)
...
5. **Big AI angry thunder-cloud** (S1): re-used from previous blocks. Already locked.

---

## Block 7 — Mechanism cashing Point 5: Nothing leaves your building
...
### Block 7.1 — The narration (Samantha, ~60s)

> *"Point five. Nothing leaves your building. Here is how."*
>
...
### Block 7.2 — Shot plan skeleton (11 shots × 6s = 66s to cover ~60s narration + 6s landing beat)

*Full shot-by-shot plan to be locked in its own file `BEESTING_2_MECH_5_SHOT_PLAN.md` when we're ready to produce clips. Skeleton here for narrative alignment.*
...
| S11 | Landing beat (plays after narration ends): zoom out on a street of sealed buildings, each glowing with its own Hive inside. Above them, a **warm smiling sun** has replaced the dark thunder-cloud — bright, kind, daytime. Held aftermath of the block; gives the audience six seconds to absorb the closer before Block 8 begins. | 6 |

---

## Block 8 — Mechanism cashing Point 6: Every sense
...
**Target length:** ~52s narration. 3 shots × 6s = 18s nominal; shots stretch in the final edit per BeeSting's audio-wins rule.

**Source:** `TheDistributedAIRevolution/chapter_12.md` (the sub-sampling mechanic — boss keeps a low-resolution, sped-up overview of the whole input; workers get full-resolution pieces of the whole).

**Locked framing (Nir 2026-04-24):**
- **S1 is GENERAL** — intro to "every sense." Not photo-specific, not sound-specific. Just "same trick for all modalities."
- **S2 is photo-specific** and carries the rapist application narration.
- **S3 is sound-specific** and carries the grandma-scam application narration.
- **On the rapist case:** the Hive does NOT prune the "non-suspicious" (woman, elderly, dog-walker). Big AI does. The suspect turns out to be a woman — the kind of person Big AI would have skipped.
- **On the scam case:** NO AI catches a cloned voice — not local LLMs, not frontier LLMs. What the Hive actually recognizes is the **script / excuse / message** pattern, compared across many connected homes to find **SIMILAR (not identical)** patterns. *"Similar, not identical. Close enough."* is the key AI-strength line.
- **Visuals stay minimal** because Kling fails when asked to render many objects in one shot. The scenes below are stripped to the fewest objects needed.

### Block 8.1 — The narration (Samantha, ~52s)

> *"Point six. Every sense. The Hive reads text, sees photos, hears speech. Same trick for all: cut the input, give each piece to one computer, keep an overview at the top. Detail plus big picture."*
>
...
### Block 8.2 — Shot plan skeleton (3 shots × 6s = 18s nominal, shots stretch per audio-wins)

| Shot | Visual | ~Sec |
|---|---|---|
| **S1** | A single **Hive icon** sits at the center of the frame. Three small icons float in toward it from around the edges of the canvas: a **photo frame** from one side, an **audio waveform** from another, a **document** from another. Each icon moves slowly toward the Hive and settles near it. Small caption across the top or bottom: **EVERY SENSE**. Nothing else on the canvas — no mechanic visuals yet; the mechanic specifics arrive in S2 and S3. This shot is the general intro to the block. | 6 |
| **S2** | A single CCTV-style photograph fills most of the frame. Visible inside the photograph: **three cartoon people — two men and one woman.** Two crossing dashed lines cut the photograph into **4 quadrants**. Each quadrant slides down out of the photograph and into its own small **computer icon** arrayed below. Above the sliced photograph, a **low-resolution blurry thumbnail of the whole photo** floats up into a slightly larger computer icon at the top (this is the boss's "big picture" view). A red flag pops above the woman's head. Nothing else in the frame — no side panels, no Big-AI-vs-Hive split, no computer icons attached directly to each person. The narration carries the rapist application and the Big-AI-skips-most-faces critique; the visual shows the mechanic (photo → quadrants → computers + overview) and the result (the woman is flagged). | 6 |
| **S3** | A single horizontal **audio waveform** fills the frame. Two vertical dashed lines split the waveform into **3 time-slices**. Each slice slides down out of the waveform and into its own small **computer icon** arrayed below. Above the sliced waveform, a smaller version of the same waveform floats up — marked with a **⏩ fast-forward symbol** (like the button on a remote control) — into its own slightly larger computer icon at the top (this is the boss's sped-up "big picture" overview). Nothing else in the frame — no grandma character, no home network, no similarity flag. The narration carries the entire grandma-scam application. Small caption: **DETAIL + OVERVIEW**. | 6 |

---

## Block 9 — Mechanism cashing Point 7: Train once, copy forever

**Named concept:** *The Ghost-Copied Radiologist.*
**Visual style:** Kurzgesagt flat 2D motion graphics.
**Palette:** silver + ghost-white + soft violet — spectral, ethereal. Reinforces the "xerox a radiologist into every room" metaphor. Distinct from previous blocks.
**Target length:** ~50s narration. 7 shots × 6s = 42s nominal. Per BeeSting's audio-wins rule (HOLY_TEXT.md production workflow), S7 (the combined stake + sun + hospital-row closer) will naturally stretch in the final edit to cover the wooden-stake paragraph at ElevenLabs' natural tempo. Block 9 is the shortest-per-word mechanism block because hospital adoption is the least certain of the nine — less airtime, same essence.
**Palantir naming carve-out:** Palantir may be named directly in Block 9 because the cited event is a documented Guardian / Intercept news story from March 2026, not a jab at a Big AI LLM lab. See `BEESTING_2_BLOCK_5_PREP.md` for full carve-out notes. The never-say-names rule remains in force for all four American Big AI labs everywhere else.
**Phrase lock:** Samantha must say the phrase "a wooden stake through the heart of the vampire" verbatim. Do not paraphrase. Vampires return from coffins. Vampires do not return from stakes.

### Block 9.1 — The narration (Samantha, ~50s)

> *"Point seven. Train once, copy forever. Here is how."*
>
> *"A hospital hires a medical AI vendor once. Their powerful AI teaches the hospital's small AI everything it knows — that's distillation. The trained file is copied to every workstation. Xerox a radiologist into every room. One bill, not forever. Using the HIVE, these weak AI's combine into one strong AI."*
>
...
### Block 9.2 — Shot plan skeleton (7 shots × 6s = 42s to cover ~50s narration)

*Full shot-by-shot plan to be locked in its own file `BEESTING_2_MECH_7_SHOT_PLAN.md` when we're ready to produce clips. Skeleton here for narrative alignment.*

| Shot | Visual | ~Sec |
|---|---|---|
| S1 | Hospital exterior at night, red-cross sign glowing. One upper-floor window glows — inside, a computer screen is just starting up its training process. | 6 |
| S2 | Split frame. Left — a huge **TEACHER** AI icon surrounded by millions of medical images, labeled **MEDICAL AI VENDOR**. Right — a small **STUDENT** AI icon in the hospital. A glowing stream of knowledge pours from Teacher's head into Student's head. A **DISTILLATION** label floats above the stream. | 6 |
| S3 | The Teacher fades to grey as a one-time dollar sign drops away. The Student stays, glowing brighter. A single glowing ghost-white disk file labeled **MELANOMA-SPECIALIST.MODEL** ejects from the Student and multiplies along a local-network diagram to every workstation in the hospital. A radiologist silhouette in the middle splits into many ghost copies, one per exam room. All workstations link by glowing network lines into one combined hive-node above the building. | 6 |
...
## Block 10 — Mechanism cashing Point 8: Yours to build

**Named concept:** *Yours to Build.*
**Visual style:** Kurzgesagt flat 2D motion graphics.
**Palette:** warm construction-orange + teal + cream — workshop / builder / customizable vibe. Distinct from previous blocks.
**Target length:** ~30s narration. 5 shots × 6s = 30s visual. Block 10 is structurally the shortest mechanism explainer — Point 8 does not carry an extra beat like Block 3's tombstones or Block 9's Palantir wooden stake.
...
### Block 10.1 — The narration (Samantha, ~30s)

> *"Point eight. The hive is yours to build. Here is what that means."*
>
...
### Block 10.2 — Shot plan skeleton (5 shots × 6s = 30s to cover ~30s narration)

*Full shot-by-shot plan to be locked in its own file `BEESTING_2_MECH_8_SHOT_PLAN.md` when we're ready to produce clips. Skeleton here for narrative alignment.*
...
## Block 11 — Mechanism cashing Point 9: Infinite stacking
...
**Target length:** ~31s narration. 3 shots × 6s = 18s nominal; S2 stretches in the final edit to cover its long narration chunk (audio-wins rule, per `LANDING_BEATS_NOT_FILLER.md`). Block 11 is intentionally short — hierarchy is self-evident once you see a pyramid stack, so Nir's old-book epilogue on "Hierarchical Hives" did not become a chapter in MadHoney either.

### Block 11.1 — The narration (Samantha, ~31s)

> *"Point nine. The Hive can stack on top of itself. When you put one hive on top of four others, the queens of the lower hives become workers to the queen of the upper hive. In the same way you can add more layers — as many as your hardware supports. China stacks half a billion computers this way. Big AI cannot stack. To scale, Big AI has to build another data center — tens of billions of dollars. The Hive runs on computers people already own. Free."*

### Block 11.2 — Shot plan skeleton (3 shots × 6s = 18s nominal, S2 stretches per audio-wins)
...
Order of mechanism explainers (Blocks 3–11) is **locked by intensity** as of 2026-04-24 — strongest / most emotionally sticky content earliest (pays-you-back + insurance-racket), architectural arguments in the middle, concluding mechanics (yours-to-build + infinite-stack) at the end. The Block 2.8 teasers and the Blocks 3–11 mechanism explainers now run in matching order 1→9. Do not re-sequence again without Nir's explicit instruction.

---

## Production notes

- **Narration recording:** each numbered sub-block (2.1, 2.2, 2.3, etc.) gets its own ElevenLabs MP3, saved to `audio/` as `E02-block2.1-samantha-open.mp3`, `E02-block2.2-tony-open.mp3`, and so on.
- **Vox pop:** each of the 10 characters gets their own MP3 (`E02-block2.3-voxpop-01-surfer.mp3` through `E02-block2.3-voxpop-10-beachbabe-return.mp3`) — 10 distinct ElevenLabs voices, chosen to fit demographic.
- **AI-Feynman:** `E02-block2.6-feynman.mp3` — generic older-male ElevenLabs voice, no voice clone.
- **DeepSeek² reveal graphic:** two OpenArt reference images needed — "DeepSeek 2" and "DeepSeek²" — then Kling interpolates with the 2 animating up into superscript as Tony speaks the word.
- **Beach babe continuity:** single OpenArt reference image of the character locked; both her clips (intro #2 and return #10) use the same image + Kling multi-reference. Character identity will not be pixel-perfect, but silhouette + wardrobe + roller blades + voice sell it.
- **"BREAKING" chyron** stays on screen during Tony's entire field segment.
- **Samantha's 9-point summary graphics:** **NO per-point animated graphics** (we don't have the production budget for nine animated graphics and Ep1's style precedent is narrator-over-visual, not narrator-with-graphics). Samantha is delivered as a talking head — reference image generated in OpenArt (ChatGPT Image 1.5), animated lip-sync via Hedra or equivalent. As she announces each numbered point, a **single static bold CATCHY-NAME TEXT CARD** appears on screen near her (like a chyron). One card per point, dissolves between. The nine catchy names, locked in 1→9 order: **THE HIVE PAYS YOU BACK · NO INTERNET NEEDED · EVERY BRANCH · SNOWDEN DIAGNOSED. THE HIVE CURES · NOTHING LEAVES YOUR BUILDING · EVERY SENSE · TRAIN ONCE, COPY FOREVER · YOURS TO BUILD · INFINITE STACK.**

---

## Voice / delivery notes

- **Samantha's open:** authoritative news-desk cadence. No smile in the voice. This is Page-One news.
- **Tony's segment:** warmer, conversational, but crisp. Classic on-the-street reporter energy.
- **Vox pop:** each character is one distinct person. Preserve Nir's exact wording — "don't" stays "don't," "doesn't" stays "doesn't." Grammar quirks belong to the characters. The 10 different voices and 10 different wardrobes carry the "every demographic" message.
