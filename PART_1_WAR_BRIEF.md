...
**REVISED 2026-04-16 AFTER TESTING — Kling audio dropped, ElevenLabs for voice:**

Testing showed Kling 3.0 Omni with audio at 1080p costs 600 credits/15sec and skips words on shorter clips. Too expensive for the full video. New plan:

- **Kling** = VIDEO ONLY (no audio), 720p, Native Audio OFF
- **ElevenLabs** = narrator voice ($6/month subscription, 30K tokens = ~30 minutes, we need ~7.5 min)
