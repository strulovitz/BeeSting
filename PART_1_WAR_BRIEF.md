...
| 5 | A4: dim corridor (end frame of S04b, already rendered) | A5: deeper wider corridor | Drone FPV moving deeper into the bunker, passing pipes and infrastructure | 8 | "Until tonight — this was impossible. Every drone in history was either flown by remote control, or too stupid to find a doorway." [FULL sentence fits inside this clip — no spill into Shot 6] |
| 6 | A5: deeper wider corridor | A6: corridor with branching paths, multiple doors visible | Drone FPV reaches a junction with several doors to choose from | 7 (5+2) | "An ant colony is a living computer. Each ant is dumb." |
| 7 | A6: corridor with branching paths | A7: drone swarm moving as coordinated group | Drones coordinating in the corridor, moving as one | 8 (6+2) | "But as a colony, they combine into an intelligent super-organism." |
| 8 | A7: coordinated swarm | A8: drones splitting into task-groups | Drones branching, each group taking a path | 6 (4+2) | "Pathfinding. The piano movers problem." |
| 9 | A8: task-groups | A9: drones moving without any central command visible | Swarm operating with no visible leader, distributed | 6 (4+2) | "All of it with no leader. No General Ant." |
| 10 | A9: leaderless swarm | A10: drones in coordinated formation, confident | Swarm moving with purpose, confident coordination | 10 (8+2) | "Our competitors only talk the talk as marketing theater: swarm intelligence. Emergence." |
| 11 | A10: confident formation | A11: close-up drones with pulsing comms light | Drones whispering to each other, alive with internal activity | 7 (5+2) | "We are the first to walk the walk. We are the first to really do it." |
| 12 | A11: close-up comms | A12: coordinated formation hinting at combining | Swarm moving in tight coordinated pattern, near-merge | 12 (10+2) | "Remember Devastator from the Transformers? A group of separate machines that combined into one giant robot far more powerful than any of them alone." |
| 13 | A12: near-merge swarm | A13: close-up pulsing comms between neighboring drones | Close-up drones whispering to each other | 8 (6+2) | "Our drones do the same thing — except they combine their minds, not their bodies." |
| 14 | A13: close-up comms | A14: night-vision green HUD boots up | Transition into HUD POV, green phosphor tint fades in | 6 (4+2) | "And instead of science fiction, it is real computer science." |
| 15 | A14: green HUD | A15: green, door, TARGET ACQUIRED | Green HUD POV approaches a door, text appears | 5 (3+2) | [no narration, visual beat] |
| 16 | A15: TARGET ACQUIRED | A16: general at desk, TERMINATE | Green HUD POV enters room, closes in on general | 6 (4+2) | [no narration, tension peak] |
| 17 | A16: TERMINATE frame | A17: same frame frozen, white pause bars | Frame freezes, pause rectangles appear | 5 (3+2) | "But before that — let me show you how we got here." |

**Chain A total: 17 clips, ~108s generated, ~94s after trimming headroom.** One seamless ride from the sky to the general's desk, with the full three-layer credibility stack (ants → competitors → Devastator) folded into the bridge. Every narration line is its own ElevenLabs recording so audio aligns cleanly with shot boundaries. No spills required — every shot has its own audio except the HUD approach (S15-S16, deliberately silent for tension).
