...
| 2 | A1: drones high in sky descending | A2: drones close to mountain, approaching vent | Drones descend through night sky toward mountain | 11 (9+2) | "Revolutionary Israeli software, inside the Chinese drones that this missile carries, will change warfare forever." |
...
| 5 | A4: dim corridor (end frame of S04b, already rendered) | A5: deeper wider corridor | Drone FPV moving deeper into the bunker, passing pipes and infrastructure | 8-10 (stretch in Premiere if needed) | "The basic idea is simple: an ant colony is a living computer, even though each ant is dumb." |
| 6 | A5: deeper wider corridor | A6: corridor with branching paths, multiple doors visible | Drone FPV reaches a junction with several doors to choose from | 7 (5+2) | "But as a colony, they combine into an intelligent super-organism." |
| 7 | A6: corridor with branching paths | A7: drone swarm moving as coordinated group | Drones coordinating in the corridor, moving as one | 6 (4+2) | "Pathfinding. The piano movers problem." |
| 8 | A7: coordinated swarm | A8: drones splitting into task-groups | Drones branching, each group taking a path | 6 (4+2) | "All of it with no leader. No General Ant." |
| 9 | A8: task-groups | A9: drones in coordinated formation, confident | Swarm moving with purpose, confident coordination | 10 (8+2) | "Our competitors only talk the talk as marketing hand-waving: swarm intelligence. Emergence." |
| 10 | A9: confident formation | A10: close-up drones with pulsing comms light | Drones whispering to each other, alive with internal activity | 7 (5+2) | "We are the first to walk the walk. We are the first to really build it." |
| 11 | A10: close-up comms | A11: coordinated formation hinting at combining | Swarm moving in tight coordinated pattern, near-merge | 12 (10+2) | "Remember Devastator from the Transformers? A group of separate machines that combined into one giant robot far more powerful than any of them alone." |
| 12 | A11: near-merge swarm | A12: close-up pulsing comms between neighboring drones | Close-up drones whispering to each other | 8 (6+2) | "Our drones do the same thing — except they combine their minds, not their bodies." |
| 13 | A12: close-up comms | A13: night-vision green HUD boots up | Transition into HUD POV, green phosphor tint fades in | 6 (4+2) | "And instead of science fiction, it is real computer science." |
| 14 | A13: green HUD | A14: green, door, TARGET ACQUIRED | Green HUD POV approaches a door, text appears | 5 (3+2) | [no narration, visual beat] |
| 15 | A14: TARGET ACQUIRED | A15: general at desk, TERMINATE | Green HUD POV enters room, closes in on general | 6 (4+2) | [no narration, tension peak] |
| 16 | A15: TERMINATE frame | A16: same frame frozen, white pause bars | Frame freezes, pause rectangles appear | 5 (3+2) | "But before that — let me show you how we got here." |

**Chain A total: 16 clips, ~100s generated, ~86s after trimming headroom.** One seamless ride from the sky to the general's desk. S02 now carries the offensive Israel+China hook ("revolutionary Israeli software inside Chinese drones will change warfare forever"), S05 opens the ants block with the "even though" paradox. Three-layer credibility stack (ants → competitors → Devastator) intact. Every narration line is its own ElevenLabs recording. No spills required — every shot has its own audio except the HUD approach (S14-S15, deliberately silent for tension).
...
| 0:15-0:30 | missile arcs over Pacific; nose cone opens; drones pour out | *"Revolutionary Israeli software, inside the Chinese drones that this missile carries, will change warfare forever."* | 👀 Secretary → 👔 Manager |
