...
| 13 | California data center | Environment | 18, 20 | 11 | LOCKED (intact Shot 18) → `elements/13_data_center.png`; LOCKED (burning Shot 20) → `elements/13b_data_center_burning.png` |
| 14 | Pentagon war room | Environment | 26 | 11 | LOCKED → `elements/14_pentagon_war_room.png` |
