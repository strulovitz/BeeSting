...
## "+ for you specifically" block (LOCKED 2026-05-05)

Insert before Section XII:

---

### + FOR YOU SPECIFICALLY — WHY HOSTING THIS DEMO IS WORTH YOUR EVENT'S TIME
...
Your audience does not run a toy demo. Maker-culture kids and hackathon students reject toy demos on sight — they have built radios and drones and robots, and they recognize hollow projects in five minutes. THE HIVE is not hollow. A hive of this kind functions in environments where centralized cloud AI cannot: a Mars colony in the middle of a six-month dust-storm communication blackout; a Europa or Titan mission where each command takes hours each way; a spacecraft beyond practical Earth contact triaging a medical emergency, calculating crop oxygen for the food plants, deciding how to handle a fault. Your audience runs the architecture that goes to space. They run it on their laptops, in your venue, and they know it works because they were inside it when it ran.
...
- `dale@make.co` — Dale Dougherty, Make: Community founder, runs Maker Faire
- `dale.dougherty@gmail.com` — Dale's personal (backup if make.co bounces)
- `editor@make.co` — Make: Magazine editorial
- `community@make.co` — Make: community
- `makerfaire@make.co` — Maker Faire team direct
- `pr@make.co` — Make: press / media
- `tickets@makerfaire.com` — Maker Faire ticketing
- `editor@hackaday.com` — Hackaday editorial
- `tips@hackaday.com` — Hackaday tip line
